...
class LinstorDirectTargetTestCase(test.TestCase):
    def __init__(self, *args, **kwargs):
        super(LinstorDirectTargetTestCase, self).__init__(*args, **kwargs)

    def setUp(self):
        super(LinstorDirectTargetTestCase, self).setUp()
...
class LinstorUtilsTestCase(test.TestCase):
    def __init__(self, *args, **kwargs):
        super(LinstorUtilsTestCase, self).__init__(*args, **kwargs)

    def setUp(self):
        super(LinstorUtilsTestCase, self).setUp()
